...
public class RemovePriceRangeTests : IClassFixture<DomainFixture>
{
    private readonly Guid _tenantId = Guid.NewGuid();
    private readonly Mock<RemovePriceRange.IRepository> _repository = new();
    private readonly Mock<IUnitOfWork> _unitOfWork = new();
    private readonly RemovePriceRange.Service _service;

    public RemovePriceRangeTests(DomainFixture fixture)
    {
        _service = new RemovePriceRange.Service(
            fixture.Get<Customer.RemovePriceRange>(),
            _tenantId,
            _repository.Object,
            _unitOfWork.Object);
    }
    ...
    [Fact]
    public async Task HandleAsync_WithExistingPriceRange_RemovesPriceRange()
    {
