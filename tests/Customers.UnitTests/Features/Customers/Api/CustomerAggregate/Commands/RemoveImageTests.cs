...
public class RemoveImageTests : IClassFixture<DomainFixture>
{
    private readonly Guid _tenantId = Guid.NewGuid();
    private readonly Mock<RemoveImage.IRepository> _repository = new();
    private readonly Mock<IUnitOfWork> _unitOfWork = new();
    private readonly RemoveImage.Service _service;

    public RemoveImageTests(DomainFixture fixture)
    {
        _service = new RemoveImage.Service(
            fixture.Get<Customer.RemoveImage>(),
            _tenantId,
            _repository.Object,
            _unitOfWork.Object);
    }
    ...
    [Fact]
    public async Task HandleAsync_WithExistingImage_RemovesImage()
    {
        ...
        await _service.HandleAsync(imageId);

        customer.Images.Should().BeEmpty();
    }
}
