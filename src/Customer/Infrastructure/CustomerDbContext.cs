...
public class CustomerDbContext : DbContext, IEntityLookup, IQuery, IChangeTracker, IUnitOfWork
{
    private readonly Guid _tenantId;

    public CustomerDbContext(DbContextOptions<CustomerDbContext> options, Guid tenantId)
        : base(options)
    {
        _tenantId = tenantId;
