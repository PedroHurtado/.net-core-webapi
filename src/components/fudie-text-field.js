...
class FudieTextField extends HTMLElement {
    static get observedAttributes() {
        return ['name', 'label', 'value', 'placeholder', 'required', 'disabled', 'type', 'error', 'hint'];
    }
...
customElements.define('fudie-text-field', FudieTextField);
